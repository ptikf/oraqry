...
exec dbms_stats.delete_table_stats ('CARP','ENTITE_LEGALE',null); 

exec DBMS_STATS.restore_TABLE_STATS('carp','log_etape_export',
...
select owner,table_name tname,column_name cname,
column_id id,
data_type,
